// Concordance model 6.1: don't try to get random component of SES
functions {
...
data {
  ...
  //vector[N] I;               // not used in this model.
}
transformed data {
  real ao0;
  real ad0;
...
model {
  ...
  // I ~ normal(SES_mean, sigi);     // Not using I in this version of the odel

...
datafile <- 'concord-7a.rds'
stanfile <- 'concord-7.1.stan'    # the model for concord-5 is the same as the one for concord-4;
...
m7a.1 <- cmdstan2rstan(stanfile, indata)
saveRDS(m7a.1, outfile)
